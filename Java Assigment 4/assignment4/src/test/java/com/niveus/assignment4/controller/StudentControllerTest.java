...
class StudentControllerTest {
    ...
    void getAllStudentsTest(){
        ...
        studentList.add(new Student(1102,"Akshay", 34, "k"));
    ...
    @Test
     void testGetStudentByRollNumber() throws DataNotFoundException {
        ...
        mockStudent.setStudentName("Thilak");
        //when
    ...
    void testCreateStudent(){
        //given
        Student student = new Student(141,"Akshay", 31, "k");
    ...
    void testUpdateStudent() throws DataNotFoundException {
        ...
        Student studentDetails = new Student(studentRollNumber,"Pushpa", 46, "Raj");
